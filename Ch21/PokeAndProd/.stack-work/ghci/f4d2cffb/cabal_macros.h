...
/* package PokeAndProd-0.1.0.0 */
#ifndef VERSION_PokeAndProd
#define VERSION_PokeAndProd "0.1.0.0"
#endif /* VERSION_PokeAndProd */
#ifndef MIN_VERSION_PokeAndProd
#define MIN_VERSION_PokeAndProd(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_PokeAndProd */
...
#define CURRENT_COMPONENT_ID "PokeAndProd-0.1.0.0-1N1H7CvuknmL5Pc1RJuAGB-PokeAndProd"
