...
/* package Beginning-0.1.0.0 */
#ifndef VERSION_Beginning
#define VERSION_Beginning "0.1.0.0"
#endif /* VERSION_Beginning */
#ifndef MIN_VERSION_Beginning
#define MIN_VERSION_Beginning(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Beginning */
...
#define CURRENT_COMPONENT_ID "Beginning-0.1.0.0-IsP1hbcTEWMK4ZDyYOMVwZ-Beginning"
